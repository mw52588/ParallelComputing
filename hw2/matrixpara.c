...
int main(int argc, char *argv[])
{
	...
	MPI_Scatter(a, N*N/numtasks, MPI_INT, a, N*N/numtasks, MPI_INT, 0, MPI_COMM_WORLD);
	MPI_Scatter(b, N*N/numtasks, MPI_INT, a, N*N/numtasks, MPI_INT, 0, MPI_COMM_WORLD);
	...
	MPI_Gather(c, N*N/numtasks, MPI_INT, c, N*N/numtasks, MPI_INT, 0, MPI_COMM_WORLD);
